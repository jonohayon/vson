            ...
            if (typeof prop === 'object') {
                ...
                if (prop.type) {
                    ...
                    if (typeof prop.type === 'object') {
                        ...
                        if (!utils.isValidDefinition(prop)) throw new Error('Property ' + key + ' has not a valid definition');
                    }
                }
                else {
                ...
                if (prop.constructor === Array){
                    ...
                    // Just an type. hah.
                    if (!utils.isValidType(prop)) throw new Error('Property ' + key + ' has no valid type');
                }
            }
        }
    }
